...
public class ChinExtraCodecs {
    ...
    /**
     * @see Codec#withAlternative(Codec, Codec)
     */
    ...
    static <A> TupleCodec.T1Codec<A> tuple(Codec<A> codec1) {
        return new TupleCodec.T1Codec<>(codec1);
    }

    static <A, B> TupleCodec.T2Codec<A, B> tuple(Codec<A> codec1, Codec<B> codec2) {
        return new TupleCodec.T2Codec<>(codec1, codec2);
    }

    static <A, B, C> TupleCodec.T3Codec<A, B, C> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3) {
        return new TupleCodec.T3Codec<>(codec1, codec2, codec3);
    }

    static <A, B, C, D> TupleCodec.T4Codec<A, B, C, D> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4) {
        return new TupleCodec.T4Codec<>(codec1, codec2, codec3, codec4);
    }

    static <A, B, C, D, E> TupleCodec.T5Codec<A, B, C, D, E> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4, Codec<E> codec5) {
        return new TupleCodec.T5Codec<>(codec1, codec2, codec3, codec4, codec5);
    }

    static <A, B, C, D, E, F> TupleCodec.T6Codec<A, B, C, D, E, F> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4, Codec<E> codec5, Codec<F> codec6) {
        return new TupleCodec.T6Codec<>(codec1, codec2, codec3, codec4, codec5, codec6);
    }

    static <A, B, C, D, E, F, G> TupleCodec.T7Codec<A, B, C, D, E, F, G> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4, Codec<E> codec5, Codec<F> codec6, Codec<G> codec7) {
        return new TupleCodec.T7Codec<>(codec1, codec2, codec3, codec4, codec5, codec6, codec7);
    }

    static <A, B, C, D, E, F, G, H> TupleCodec.T8Codec<A, B, C, D, E, F, G, H> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4, Codec<E> codec5, Codec<F> codec6, Codec<G> codec7, Codec<H> codec8) {
        return new TupleCodec.T8Codec<>(codec1, codec2, codec3, codec4, codec5, codec6, codec7, codec8);
    }

    static <A, B, C, D, E, F, G, H, I> TupleCodec.T9Codec<A, B, C, D, E, F, G, H, I> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4, Codec<E> codec5, Codec<F> codec6, Codec<G> codec7, Codec<H> codec8, Codec<I> codec9) {
        return new TupleCodec.T9Codec<>(codec1, codec2, codec3, codec4, codec5, codec6, codec7, codec8, codec9);
    }

    static <A, B, C, D, E, F, G, H, I, J> TupleCodec.T10Codec<A, B, C, D, E, F, G, H, I, J> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4, Codec<E> codec5, Codec<F> codec6, Codec<G> codec7, Codec<H> codec8, Codec<I> codec9, Codec<J> codec10) {
        return new TupleCodec.T10Codec<>(codec1, codec2, codec3, codec4, codec5, codec6, codec7, codec8, codec9, codec10);
    }

    static <A, B, C, D, E, F, G, H, I, J, K> TupleCodec.T11Codec<A, B, C, D, E, F, G, H, I, J, K> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4, Codec<E> codec5, Codec<F> codec6, Codec<G> codec7, Codec<H> codec8, Codec<I> codec9, Codec<J> codec10, Codec<K> codec11) {
        return new TupleCodec.T11Codec<>(codec1, codec2, codec3, codec4, codec5, codec6, codec7, codec8, codec9, codec10, codec11);
    }

    static <A, B, C, D, E, F, G, H, I, J, K, L> TupleCodec.T12Codec<A, B, C, D, E, F, G, H, I, J, K, L> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4, Codec<E> codec5, Codec<F> codec6, Codec<G> codec7, Codec<H> codec8, Codec<I> codec9, Codec<J> codec10, Codec<K> codec11, Codec<L> codec12) {
        return new TupleCodec.T12Codec<>(codec1, codec2, codec3, codec4, codec5, codec6, codec7, codec8, codec9, codec10, codec11, codec12);
    }

    static <A, B, C, D, E, F, G, H, I, J, K, L, M> TupleCodec.T13Codec<A, B, C, D, E, F, G, H, I, J, K, L, M> tuple(Codec<A> codec1, Codec<B> codec2, Codec<C> codec3, Codec<D> codec4, Codec<E> codec5, Codec<F> codec6, Codec<G> codec7, Codec<H> codec8, Codec<I> codec9, Codec<J> codec10, Codec<K> codec11, Codec<L> codec12, Codec<M> codec13) {
